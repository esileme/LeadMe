package com.yl.leadme.adapter;

import android.support.v7.widget.RecyclerView;
import android.view.ViewGroup;

import com.avos.avoscloud.im.v2.AVIMMessage;
import com.yl.leadme.AVImClientManager;
import com.yl.leadme.viewholder.AVCommonViewHolder;
import com.yl.leadme.viewholder.LeftTextHolder;
import com.yl.leadme.viewholder.RightTextHolder;
...
public class MultipleItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
    ((AVCommonViewHolder<AVIMMessage>)holder).bindData(messageList.get(position));
